...
fun IkinciSayfa(navController: NavController) {
    ...
    Box(
        ...
        IconButton(
            ...
            modifier = Modifier.align(Alignment.BottomEnd).padding(20.dp).size(75.dp)
        ) {
            Icon(
        ...
        IconButton(
            ...
            modifier = Modifier.align(Alignment.BottomStart).padding(20.dp).size(75.dp)
        ) {
            Icon(
                Icons.Filled.ArrowCircleLeft,
                contentDescription = "Sol alt köşe ikonu")
        }
    }
